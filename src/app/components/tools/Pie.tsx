...
// function para el componente de server
export default function Pie() {
  // return dell componente renderizado de la propiedades necesarias
  // en este componente encontramos la informacion personal del programador wilson sanchez un 
  // logo y diferentes redireccionamientos a paginas de comunicacion.
  return (
